view: ad_group_insights_by_age_gender {
  sql_table_name: `@{GCP_PROJECT_ID}.@{REPORTING_DATASET}.AdGroupInsightsByAgeGender` ;;
  ...
  dimension: gender {
    type: string
    description: "The gender of your audience. For example: Male, Female, or Unknown."
    sql: ${TABLE}.gender ;;
  }
